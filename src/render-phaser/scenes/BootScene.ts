...
export class BootScene extends Scene {
  ...
  preload(): void {
    ...
    this.load.spritesheet('mob-imp', 'assets/lpc/mobs/imp.png', { frameWidth: 64, frameHeight: 64 });
    this.load.spritesheet('mob-goblin', 'assets/lpc/mobs/goblin.png', { frameWidth: 64, frameHeight: 64 });
