...
const baseEnTable = {
  ...
  'groundPickup.highwatchSummonsDeny': 'The summons are sealed with Summit Watch wax.',
  ...
  'groundPickup.fenMusterOrderEnough': 'You already have the Backwater Landing muster order.',
  ...
  'groundPickup.highwatchSummonsEnough': 'You already have the Summit Watch summons.',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'groundPickup.highwatchSummonsDeny': 'La citación está sellada con cera de Summit Watch.',
    ...
    'groundPickup.fenMusterOrderEnough': 'Ya tienes la orden de alistamiento de Backwater Landing.',
    ...
    'groundPickup.highwatchSummonsEnough': 'Ya tienes la citación de Summit Watch.',
  ...
  es_ES: {
    ...
    'groundPickup.highwatchSummonsDeny': 'La citación está sellada con lacre de Summit Watch.',
    'groundPickup.ogreWarTotemDeny': 'El tótem está clavado con demasiada firmeza para arrancarlo.',
  ...
  fr_FR: {
    ...
    'groundPickup.highwatchSummonsDeny': 'La convocation est scellée à la cire de Summit Watch.',
    ...
    'groundPickup.fenMusterOrderEnough': "Vous avez déjà l'ordre de rassemblement de Backwater Landing.",
    ...
    'groundPickup.highwatchSummonsEnough': 'Vous avez déjà la convocation de Summit Watch.',
  ...
  it_IT: {
    ...
    'groundPickup.highwatchSummonsDeny': 'La convocazione è sigillata con la cera di Summit Watch.',
    ...
    'groundPickup.fenMusterOrderEnough': "Hai già l'ordine di raduno di Backwater Landing.",
    ...
    'groundPickup.highwatchSummonsEnough': 'Hai già la convocazione di Summit Watch.',
  ...
  de_DE: {
    ...
    'groundPickup.highwatchSummonsDeny': 'Die Einberufung ist mit Summit Watch-Wachs versiegelt.',
    ...
    'groundPickup.fenMusterOrderEnough': 'Ihr habt den Musterungsbefehl von Backwater Landing bereits.',
    ...
    'groundPickup.highwatchSummonsEnough': 'Ihr habt die Einberufung von Summit Watch bereits.',
  ...
  pt_BR: {
    ...
    'groundPickup.highwatchSummonsDeny': 'A convocação está selada com cera de Summit Watch.',
    ...
    'groundPickup.fenMusterOrderEnough': 'Você já tem a ordem de convocação de Backwater Landing.',
    ...
    'groundPickup.highwatchSummonsEnough': 'Você já tem a convocação de Summit Watch.',
...
export const QUEST_EXTRA: Record<SupportedLanguage, Record<QuestExtraKey, string>> = {
  en: {
    ...
    aldrenYell: '{name} yells, "None shall disturb the king\'s rest! For Summit!"',
  ...
  es: {
    ...
    aldrenYell: '{name} grita: "¡Nadie perturbará el descanso del rey! ¡Por Summit!"',
  ...
  fr_FR: {
    ...
    aldrenYell: '{name} crie: "Nul ne troublera le repos du roi! Pour Summit!"',
  ...
  it_IT: {
    ...
    aldrenYell: '{name} grida: "Nessuno disturberà il riposo del re! Per Summit!"',
  ...
  de_DE: {
    ...
    aldrenYell: '{name} ruft: "Niemand stört die Ruhe des Königs! Für Summit!"',
  ...
  zh_CN: {
    ...
    awakens: '{name}苏醒了！',
    aldrenYell: '{name}喊道：“谁也不得惊扰国王的安眠！为了 Summit！”',
  ...
  zh_TW: {
    ...
    awakens: '{name}甦醒了！',
    aldrenYell: '{name}喊道：「誰也不得驚擾國王的安眠！為了 Summit！」',
  ...
  ko_KR: {
    ...
    aldrenYell: '{name}이(가) 외칩니다. "누구도 왕의 안식을 방해할 수 없다! Summit를 위하여!"',
    malricYell:
  ...
  ja_JP: {
    ...
    awakens: '{name}が目覚めた！',
    aldrenYell: '{name}が叫ぶ。「王の眠りを乱す者は許さぬ！ Summitのために！」',
  ...
  pt_BR: {
    ...
    aldrenYell: '{name} grita: "Ninguém perturbará o descanso do rei! Por Summit!"',
  ...
  ru_RU: {
    ...
    aldrenYell: '{name} кричит: "Никто не потревожит покой короля! За Summit!"',
    malricYell:
...
const RULES: Rule[] = [
  ...
  {
    re: /^(.+) rises over Summit Frontier!$/,
    build: (m) => t('hudChrome.worldBoss.spawn', { name: locMob(m[1]) }),
  },
  {
    re: /^Fallen Captain Aldren yells, "None shall disturb the king's rest! For Summit!"$/,
