...
export const en = {
  ...
  playerCard: {
    ...
    shareText:
      "I'm forging my legend in BharatVerse: Level {level} {className}{tierBit}. Join my world:",
    nativeShareTitle: 'BharatVerse',
