...
export const shellStrings = {
  en: {
    seo: {
      ...
      description:
        'Learn while you play in BharatVerse, India\'s first educational MMO. Explore a persistent shared world, master subjects through active recall, and adventure with players across the country — right in your browser.',
      genre: 'MMORPG',
      ...
      officialBody:
        'BharatVerse is India\'s first educational MMO: play online with a persistent character, master subjects through active recall, read the wiki, and follow verified community links from this site.',
    },
    a11y: {
    ...
    desktop: {
      ...
      crash: {
        ...
        reload: 'Reload',
        quit: 'Quit',
        fatalBody: 'BharatVerse hit an unexpected error and needs to close.',
      },
    },
    realm: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Open BharatVerse from the new Home Screen icon.',
      ...
      androidOpenStep: 'Open BharatVerse from the new icon.',
    ...
    serverUnavailable: {
      title: 'BharatVerse - World Unavailable',
      logoAlt: 'BharatVerse',
      eyebrow: 'World maintenance',
      heading: 'The world is temporarily unavailable.',
      body: 'We are restarting the game service and expect Bharat to return shortly. This page will keep checking automatically.',
      status: 'Back soon',
    },
  },
  es: {
    seo: {
      ...
      description:
        'Emprende una aventura épica en BharatVerse, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto de BharatVerse en GitHub',
    ...
    serverUnavailable: {
      title: 'BharatVerse - Reino no disponible',
      logoAlt: 'BharatVerse',
  ...
  es_ES: {
    seo: {
      title: 'BharatVerse: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en BharatVerse, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.',
      genre: 'MMORPG',
      playMode: 'Multijugador',
      applicationCategory: 'Juego',
      operatingSystem: 'Navegador web',
  ...
  fr_FR: {
    seo: {
      title: 'BharatVerse: MMO web de style classique',
      description:
        'Partez pour une aventure épique dans BharatVerse, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Ouvrir le projet BharatVerse sur GitHub',
      discordCommunity: 'Rejoindre la communauté BharatVerse sur Discord',
      donateProject: 'Faire un don pour soutenir BharatVerse',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Ouvrez BharatVerse depuis la nouvelle icône de l'écran d'accueil.",
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Ouvrez BharatVerse depuis la nouvelle icône.',
    ...
    serverUnavailable: {
      title: 'BharatVerse - Royaume indisponible',
      logoAlt: 'BharatVerse',
      eyebrow: 'Maintenance du royaume',
      heading: 'Le royaume est temporairement indisponible.',
      body: 'Nous redémarrons le service de jeu et Bharat devrait revenir bientôt. Cette page continuera de vérifier automatiquement.',
  ...
  fr_CA: {
    seo: {
      title: 'BharatVerse: MMO Web de style classique',
      description:
        "Partez à l'aventure dans BharatVerse, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
      genre: 'MMORPG',
      playMode: 'Multijoueur',
      applicationCategory: 'Jeu',
      operatingSystem: 'Navigateur Web',
    ...
    serverUnavailable: {
      ...
      eyebrow: 'Maintenance du royaume',
      heading: 'Le royaume est temporairement indisponible.',
      body: 'Nous redémarrons le service de jeu et Bharat devrait revenir sous peu. Cette page continuera de vérifier automatiquement.',
      status: 'De retour bientôt',
    },
  },
  en_CA: {
    seo: {
      title: 'BharatVerse: Classic-Style Web MMO',
      description:
        'Embark on an epic adventure in BharatVerse, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!',
      genre: 'MMORPG',
      playMode: 'Multiplayer',
      applicationCategory: 'Game',
      operatingSystem: 'Web browser',
    ...
    serverUnavailable: {
      title: 'BharatVerse - Realm Unavailable',
      logoAlt: 'BharatVerse',
  ...
  it_IT: {
    seo: {
      title: 'BharatVerse: MMO web in stile classico',
      description:
        "Parti per un'avventura epica in BharatVerse, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Apri il progetto BharatVerse su GitHub',
      discordCommunity: 'Entra nella community Discord di BharatVerse',
      donateProject: 'Fai una donazione per sostenere BharatVerse',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Apri BharatVerse dalla nuova icona nella schermata Home.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Apri BharatVerse dalla nuova icona.',
    ...
    serverUnavailable: {
      title: 'BharatVerse - Reame non disponibile',
      logoAlt: 'BharatVerse',
      eyebrow: 'Manutenzione del reame',
      heading: 'Il reame è temporaneamente non disponibile.',
      body: 'Stiamo riavviando il servizio di gioco e prevediamo che Bharat torni a breve. Questa pagina continuerà a controllare automaticamente.',
      status: 'Torna presto',
    },
  },
  de_DE: {
    seo: {
      title: 'BharatVerse: Klassisches Web-MMO',
      description:
        'Begib dich in BharatVerse auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'BharatVerse-Projekt auf GitHub öffnen',
      discordCommunity: 'Der BharatVerse-Community auf Discord beitreten',
      donateProject: 'Spenden, um BharatVerse zu unterstützen',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Öffne BharatVerse über das neue Symbol auf dem Home-Bildschirm.',
      ...
      androidOpenStep: 'Öffne BharatVerse über das neue Symbol.',
    ...
    serverUnavailable: {
      title: 'BharatVerse - Realm nicht verfügbar',
      logoAlt: 'BharatVerse',
      eyebrow: 'Realmwartung',
      heading: 'Der Realm ist vorübergehend nicht verfügbar.',
      body: 'Wir starten den Spieldienst neu und erwarten, dass Bharat bald zurückkehrt. Diese Seite prüft automatisch weiter.',
      status: 'Bald zurück',
    },
  },
  zh_CN: {
    seo: {
      title: 'BharatVerse：经典风格网页 MMO',
      description:
        '在 BharatVerse 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。',
      genre: 'MMORPG',
      playMode: '多人游戏',
    ...
    a11y: {
      ...
      githubProject: '打开 BharatVerse 的 GitHub 项目',
      discordCommunity: '加入 BharatVerse 的 Discord 社区',
      donateProject: '捐赠支持 BharatVerse',
    },
    loading: {
      world: '正在加载世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '从新的主屏幕图标打开 BharatVerse。',
      ...
      androidOpenStep: '从新图标打开 BharatVerse。',
      otherStandaloneDetail: '请保持设备处于横屏全屏。',
      otherInstallDetail: '安装此页面或将其添加到主屏幕，以获得最佳移动端全屏体验。',
    },
    serverUnavailable: {
      title: 'BharatVerse - 服务器不可用',
      logoAlt: 'BharatVerse',
      eyebrow: '服务器维护',
      heading: '服务器暂时不可用。',
      body: '我们正在重启游戏服务，Bharat 应会很快恢复。此页面会自动继续检查。',
      status: '即将恢复',
    },
  },
  zh_TW: {
    seo: {
      title: 'BharatVerse：經典風格網頁 MMO',
      description:
        '在 BharatVerse 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。',
      genre: 'MMORPG',
      playMode: '多人遊戲',
    ...
    a11y: {
      ...
      characterActions: '角色操作',
      githubProject: '開啟 BharatVerse 的 GitHub 專案',
      discordCommunity: '加入 BharatVerse 的 Discord 社群',
      donateProject: '捐贈支持 BharatVerse',
    },
    loading: {
      world: '正在載入世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '從新的主畫面圖示開啟 BharatVerse。',
      ...
      androidOpenStep: '從新圖示開啟 BharatVerse。',
      otherStandaloneDetail: '請保持裝置為橫向全螢幕。',
      otherInstallDetail: '安裝此頁面或將其加入主畫面，以獲得最佳行動裝置全螢幕體驗。',
    },
    serverUnavailable: {
      title: 'BharatVerse - 伺服器不可用',
      logoAlt: 'BharatVerse',
      eyebrow: '伺服器維護',
      heading: '伺服器暫時不可用。',
      body: '我們正在重新啟動遊戲服務，Bharat 應會很快恢復。此頁面會自動持續檢查。',
      status: '即將恢復',
    },
  },
  ko_KR: {
    seo: {
      title: 'BharatVerse: 클래식 스타일 웹 MMO',
      description:
        '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, BharatVerse에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.',
      genre: 'MMORPG',
      playMode: '멀티플레이어',
    ...
    a11y: {
      ...
      githubProject: 'GitHub에서 BharatVerse 프로젝트 열기',
      discordCommunity: 'BharatVerse Discord 커뮤니티 참여',
      donateProject: 'BharatVerse 후원하기',
    },
    loading: {
      world: '세계 불러오는 중...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '새 홈 화면 아이콘에서 BharatVerse를 여세요.',
      ...
      androidOpenStep: '새 아이콘에서 BharatVerse를 여세요.',
      otherStandaloneDetail: '기기를 가로 전체 화면으로 유지하세요.',
      otherInstallDetail:
        '최상의 모바일 전체 화면 경험을 위해 이 페이지를 설치하거나 홈 화면에 추가하세요.',
    },
    serverUnavailable: {
      title: 'BharatVerse - 렐름 이용 불가',
      logoAlt: 'BharatVerse',
      eyebrow: '렐름 점검',
      heading: '렐름을 일시적으로 이용할 수 없습니다.',
      body: '게임 서비스를 재시작하고 있으며 Bharat은 곧 돌아올 예정입니다. 이 페이지는 자동으로 계속 확인합니다.',
      status: '곧 돌아옵니다',
    },
  },
  ja_JP: {
    seo: {
      title: 'BharatVerse: クラシック風Web MMO',
      description:
        'ブラウザで直接遊べるクラシック風マイクロMMO、BharatVerse で壮大な冒険に出ましょう。永続的な共有レルムに参加し、クラスを育て、敵を倒してください。',
      genre: 'MMORPG',
      playMode: 'マルチプレイヤー',
    ...
    a11y: {
      ...
      githubProject: 'GitHubでBharatVerseプロジェクトを開く',
      discordCommunity: 'BharatVerseのDiscordコミュニティに参加',
      donateProject: 'BharatVerseを支援するために寄付',
    },
    loading: {
      world: '世界を読み込み中...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '新しいホーム画面アイコンからBharatVerseを開きます。',
      ...
      androidOpenStep: '新しいアイコンからBharatVerseを開きます。',
      otherStandaloneDetail: '端末を横向き全画面に保ってください。',
      otherInstallDetail:
        '最高のモバイル全画面体験のため、このページをインストールするかホーム画面に追加してください。',
    },
    serverUnavailable: {
      title: 'BharatVerse - レルム利用不可',
      logoAlt: 'BharatVerse',
      eyebrow: 'レルムメンテナンス',
      heading: 'レルムは一時的に利用できません。',
      body: 'ゲームサービスを再起動しています。Bharatはまもなく戻る予定です。このページは自動的に確認を続けます。',
      status: 'まもなく復帰',
    },
  },
  pt_BR: {
    seo: {
      title: 'BharatVerse: MMO web em estilo clássico',
      description:
        'Embarque em uma aventura épica em BharatVerse, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir o projeto BharatVerse no GitHub',
      discordCommunity: 'Entrar na comunidade BharatVerse no Discord',
      donateProject: 'Doar para apoiar BharatVerse',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abra BharatVerse pelo novo ícone na tela inicial.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Abra BharatVerse pelo novo ícone.',
    ...
    serverUnavailable: {
      title: 'BharatVerse - Reino indisponível',
      logoAlt: 'BharatVerse',
      eyebrow: 'Manutenção do reino',
      heading: 'O reino está temporariamente indisponível.',
      body: 'Estamos reiniciando o serviço do jogo e esperamos que Bharat volte em breve. Esta página continuará verificando automaticamente.',
      status: 'Voltamos em breve',
    },
  },
  ru_RU: {
    seo: {
      title: 'BharatVerse: веб-MMO в классическом стиле',
      description:
        'Отправьтесь в эпическое приключение в BharatVerse, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Открыть проект BharatVerse на GitHub',
      discordCommunity: 'Присоединиться к Discord-сообществу BharatVerse',
      donateProject: 'Пожертвовать на поддержку BharatVerse',
    },
    loading: {
      world: 'Загрузка мира...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Откройте BharatVerse через новый значок на домашнем экране.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Откройте BharatVerse через новый значок.',
    ...
    serverUnavailable: {
      title: 'BharatVerse - мир недоступен',
      logoAlt: 'BharatVerse',
      eyebrow: 'Технические работы',
      heading: 'Мир временно недоступен.',
      body: 'Мы перезапускаем игровой сервис и ожидаем, что Bharat скоро вернется. Эта страница продолжит проверку автоматически.',
