...
export const it_IT: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.docTitle': 'Editor di Mappe - BharatVerse',
  ...
  'seo.officialLabel': 'Sito ufficiale di BharatVerse',
  'seo.officialBody':
    "worldofclaudecraft.com è l'MMO gratuito ufficiale da browser del mondo Bharat. Gioca online con un personaggio persistente, esplora offline in solitaria, leggi il wiki e segui i link della community verificati da questo sito.",
  ...
  'playerCard.shareText':
    'Sto forgiando la mia leggenda in BharatVerse: livello {level} {className}{tierBit}. Unisciti al mio mondo:',
  ...
  'seo.description':
    "Parti per un'avventura epica in BharatVerse, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un mondo condiviso persistente, fai crescere le classi e sconfiggi i nemici!",
  'seo.genre': 'MMORPG',
  ...
  'mobilePreflight.iosOpenStep':
    'Apri BharatVerse dalla nuova icona nella schermata Home.',
  ...
  'serverUnavailable.title': 'BharatVerse - Mondo non disponibile',
  ...
  'serverUnavailable.body':
    'Stiamo riavviando il servizio di gioco e prevediamo che Bharat torni a breve. Questa pagina continuerà a controllare automaticamente.',
  ...
  'guide.worldPage.intro':
    "BharatVerse è una terra continua che attraversi a piedi, tre zone disposte da sud a nord. Non c'è viaggio rapido, perciò il viaggio è parte dell'avventura.",
  ...
  'hudChrome.discord.swag.titleChampion': 'Titolo: Campione di Bharat',
  ...
  'desktop.crash.fatalBody':
    'BharatVerse ha riscontrato un errore imprevisto e deve chiudersi.',
  ...
  'hudChrome.nativeUpdate.body':
    'È disponibile una nuova versione di BharatVerse. Aggiorna ora per le ultime correzioni e migliorie.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'La versione {version} di BharatVerse è disponibile. Aggiorna ora per le ultime correzioni e migliorie.',
