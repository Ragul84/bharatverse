...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'BharatVerse 官方网站',
  'seo.officialBody':
    'worldofclaudecraft.com 是 Bharat 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。',
  ...
  'playerCard.shareText':
    '我正在 BharatVerse 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：',
  ...
  'seo.description':
    '在 BharatVerse 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'serverUnavailable.body': '我们正在重启游戏服务，Bharat 应会很快恢复。此页面会自动继续检查。',
  ...
  'guide.worldPage.intro':
    'BharatVerse 是一片连绵不绝、需你徒步穿越的大陆，三大区域由南向北依次铺展。这里没有快速旅行，因此旅途本身便是冒险的一部分。',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Bharat 勇士',
  ...
  'hudChrome.nativeUpdate.body':
    'BharatVerse 有新版本可用。立即更新以获取最新修复和改进。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'BharatVerse {version} 版本已可用。立即更新以获取最新修复和改进。',
  ...
  'desktop.crash.fatalBody': 'BharatVerse 遇到意外错误，需要关闭。',
  'editor.appTitle': '地图编辑器',
  'editor.docTitle': '地图编辑器 - BharatVerse',
