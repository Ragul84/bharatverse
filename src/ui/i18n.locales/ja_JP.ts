...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'BharatVerse 公式サイト',
  'seo.officialBody':
    'worldofclaudecraft.com は Bharat ワールドの公式無料ブラウザMMOです。永続キャラクターでオンラインプレイし、オフラインでソロ探索し、wikiを読み、このサイトから確認済みのコミュニティリンクをたどれます。',
  ...
  'playerCard.shareText':
    'BharatVerseで伝説を鍛えています: レベル{level} {className}{tierBit}。私のワールドに参加してください:',
  ...
  'seo.description':
    'ブラウザで直接遊べるクラシック風マイクロMMO、BharatVerse で壮大な冒険に出ましょう。永続的な共有ワールドに参加し、クラスを育て、敵を倒してください。',
  'seo.genre': 'MMORPG',
  ...
  'guide.worldPage.intro':
    'BharatVerseは、自らの足で歩いて渡る一続きの大地です。南から北へと3つのゾーンが連なっています。ファストトラベルはなく、その旅路こそが冒険の一部です。',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Bharatのチャンピオン',
  ...
  'hudChrome.nativeUpdate.body':
    'BharatVerse の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'BharatVerse のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  ...
  'desktop.crash.fatalBody': 'BharatVerse で予期しないエラーが発生したため、終了します。',
  'editor.appTitle': 'マップエディター',
  'editor.docTitle': 'マップエディター - BharatVerse',
