...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Site oficial de BharatVerse',
  'seo.officialBody':
    'worldofclaudecraft.com é o MMO de navegador gratuito oficial do mundo Bharat. Jogue online com um personagem persistente, explore solo offline, leia a wiki e siga os links verificados da comunidade a partir deste site.',
  ...
  'playerCard.shareText':
    'Estou forjando minha lenda em BharatVerse: nível {level} {className}{tierBit}. Entre no meu mundo:',
  ...
  'seo.description':
    'Embarque em uma aventura épica em BharatVerse, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um mundo compartilhado persistente, evolua classes e derrote inimigos!',
  'seo.genre': 'MMORPG',
  ...
  'serverUnavailable.title': 'BharatVerse - Mundo indisponível',
  ...
  'serverUnavailable.body':
    'Estamos reiniciando o serviço do jogo e esperamos que Bharat volte em breve. Esta página continuará verificando automaticamente.',
  ...
  'guide.worldPage.intro':
    'BharatVerse é uma terra contínua que você atravessa a pé, três zonas dispostas de sul a norte. Não há viagem rápida, então a jornada faz parte da aventura.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Título: Campeão de Bharat',
  ...
  'desktop.crash.fatalBody':
    'O BharatVerse encontrou um erro inesperado e precisa fechar.',
  ...
  'hudChrome.nativeUpdate.body':
    'Uma nova versão do BharatVerse está disponível. Atualize agora para receber as últimas correções e melhorias.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'A versão {version} do BharatVerse está disponível. Atualize agora para receber as últimas correções e melhorias.',
