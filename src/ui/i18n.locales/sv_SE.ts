...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.docTitle': 'Kartredigerare - BharatVerse',
  ...
  'entities.npcs.auctioneer_voss.greeting':
    'BharatVerse-marknaden är öppen även här, {className}. Köp från varje äventyrare i riket, eller lägg ut dina egna varor.',
  ...
  'a11y.discordCommunity': 'Gå med i BharatVerse-gemenskapen på Discord',
  'a11y.donateProject': 'Donera för att stödja BharatVerse',
  'a11y.githubProject': 'Öppna GitHub-projektet BharatVerse',
  ...
  'guide.worldPage.intro':
    'BharatVerse är ett enda sammanhängande land som du korsar till fots, tre zoner lagda från söder till norr. Det finns ingen snabbresa, så resan är en del av äventyret.',
  ...
  'mobilePreflight.androidOpenStep': 'Öppna BharatVerse från den nya ikonen.',
  ...
  'mobilePreflight.iosOpenStep': 'Öppna BharatVerse från den nya Hemskärmsikonen.',
  ...
  'mode.play': 'Spela',
  'mode.playAria': 'Spela BharatVerse',
  ...
  'playerCard.shareText':
    'Jag skapar min legend i BharatVerse: Nivå {level} {className}{tierBit}. Gå med i min värld:',
  ...
  'seo.description':
    'Ge dig ut på ett episkt äventyr i BharatVerse, en klassiskt inspirerad mikro-MMO som du spelar direkt i din webbläsare. Anslut till en beständig delad värld, höj nivå på klasser och besegra fiender!',
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'worldofclaudecraft.com är den officiella gratis webbläsar-MMO:n för Bharat-världen. Spela online med en beständig karaktär, utforska solo offline, läs wikin och följ verifierade gemenskapslänkar från den här webbplatsen.',
  'seo.officialLabel': 'Officiell webbplats för BharatVerse',
  'seo.operatingSystem': 'Webbläsare',
  'seo.playMode': 'Flerspelarläge',
  'seo.title': 'BharatVerse: Klassiskt inspirerad webb-MMO',
  'serverUnavailable.body':
    'Vi startar om speltjänsten och förväntar oss att Bharat är tillbaka inom kort. Den här sidan fortsätter att kontrollera automatiskt.',
  ...
  'serverUnavailable.title': 'BharatVerse - Världen otillgänglig',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titel: Champion of Bharat',
  ...
  'desktop.crash.fatalBody': 'BharatVerse stötte på ett oväntat fel och måste stängas.',
  ...
  'hudChrome.nativeUpdate.body':
    'En ny version av BharatVerse är tillgänglig. Uppdatera nu för de senaste korrigeringarna och förbättringarna.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Version {version} av BharatVerse är tillgänglig. Uppdatera nu för de senaste korrigeringarna och förbättringarna.',
