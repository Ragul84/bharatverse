...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Официальный сайт BharatVerse',
  'seo.officialBody':
    'worldofclaudecraft.com - официальная бесплатная браузерная MMO для мира Bharat. Играйте онлайн с постоянным персонажем, исследуйте мир в одиночку офлайн, читайте wiki и переходите по проверенным ссылкам сообщества с этого сайта.',
  ...
  'playerCard.shareText':
    'Я создаю свою легенду в BharatVerse: уровень {level}, {className}{tierBit}. Присоединяйтесь к моему миру:',
  ...
  'seo.description':
    'Отправьтесь в эпическое приключение в BharatVerse, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к постоянному общему миру, развивайте классы и побеждайте врагов.',
  'seo.genre': 'MMORPG',
  ...
  'mobilePreflight.iosOpenStep':
    'Откройте BharatVerse через новый значок на домашнем экране.',
  ...
  'serverUnavailable.body':
    'Мы перезапускаем игровой сервис и ожидаем, что Bharat скоро вернется. Эта страница продолжит проверку автоматически.',
  ...
  'guide.worldPage.intro':
    'BharatVerse - это единый цельный край, который вы пересекаете пешком, три зоны, протянувшиеся с юга на север. Здесь нет быстрых перемещений, так что дорога - это часть приключения.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Титул: Чемпион Bharat',
  ...
  'hudChrome.nativeUpdate.body':
    'Доступна новая версия BharatVerse. Обновите сейчас, чтобы получить последние исправления и улучшения.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Доступна версия {version} BharatVerse. Обновите сейчас, чтобы получить последние исправления и улучшения.',
  ...
  'desktop.crash.fatalBody':
    'BharatVerse столкнулась с непредвиденной ошибкой и будет закрыта.',
  'editor.appTitle': 'Редактор карт',
  'editor.docTitle': 'Редактор карт - BharatVerse',
