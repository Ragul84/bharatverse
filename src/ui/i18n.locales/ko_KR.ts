...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'BharatVerse 공식 웹사이트',
  'seo.officialBody':
    'worldofclaudecraft.com은 Bharat 월드의 공식 무료 브라우저 MMO입니다. 지속 캐릭터로 온라인 플레이를 하거나, 오프라인에서 혼자 탐험하고, 위키를 읽고, 이 사이트에서 검증된 커뮤니티 링크를 확인하세요.',
  ...
  'playerCard.shareText':
    'BharatVerse에서 제 전설을 벼리고 있습니다: {level}레벨 {className}{tierBit}. 제 월드에 합류하세요:',
  ...
  'seo.description':
    '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, BharatVerse에서 장대한 모험을 시작하세요. 지속되는 공유 월드에 접속해 직업을 성장시키고 적을 물리치세요.',
  'seo.genre': 'MMORPG',
  'seo.playMode': '멀티플레이어',
  ...
  'guide.worldPage.intro':
    'BharatVerse는 두 발로 가로지르는 하나로 이어진 대지이며, 남에서 북으로 펼쳐진 세 개의 지역으로 이루어져 있습니다. 빠른 이동이 없으니, 여정 자체가 모험의 일부입니다.',
  ...
  'hudChrome.discord.swag.titleChampion': '칭호: Bharat의 챔피언',
  ...
  'hudChrome.nativeUpdate.body':
    'BharatVerse의 새 버전을 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'BharatVerse 버전 {version}을(를) 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  ...
  'desktop.crash.fatalBody': 'BharatVerse에 예기치 않은 오류가 발생하여 종료해야 합니다.',
  'editor.appTitle': '맵 편집기',
  'editor.docTitle': '맵 편집기 - BharatVerse',
