...
export const es_ES: Partial<Record<TranslationKey, string>> = {
  ...
  "seo.description": "Emprende una aventura épica en BharatVerse, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.",
