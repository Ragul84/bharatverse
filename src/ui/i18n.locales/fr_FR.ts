...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.docTitle': 'Éditeur de cartes - BharatVerse',
  ...
  'seo.officialLabel': 'Site officiel de BharatVerse',
  'seo.officialBody':
    'worldofclaudecraft.com est le MMO gratuit officiel sur navigateur du monde Bharat. Jouez en ligne avec un personnage persistant, explorez en solo hors ligne, lisez le wiki et suivez les liens communautaires vérifiés depuis ce site.',
  ...
  'playerCard.shareText':
    'Je forge ma légende dans BharatVerse : niveau {level} {className}{tierBit}. Rejoignez mon monde :',
  ...
  'seo.description':
    'Partez pour une aventure épique dans BharatVerse, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un monde persistant, progressez en classe et terrassez vos ennemis.',
  'seo.genre': 'MMORPG',
  ...
  'mobilePreflight.iosOpenStep':
    "Ouvrez BharatVerse depuis la nouvelle icône de l'écran d'accueil.",
  ...
  'serverUnavailable.title': 'BharatVerse - Monde indisponible',
  ...
  'serverUnavailable.body':
    'Nous redémarrons le service de jeu et Bharat devrait revenir bientôt. Cette page continuera de vérifier automatiquement.',
  ...
  'guide.worldPage.intro':
    "BharatVerse est une seule terre continue que l'on traverse à pied, trois zones disposées du sud au nord. Il n'y a pas de voyage rapide, alors le trajet fait partie de l'aventure.",
  ...
  'hudChrome.discord.swag.titleChampion': 'Titre: Champion de Bharat',
  ...
  'desktop.crash.fatalBody':
    'BharatVerse a rencontré une erreur inattendue et doit se fermer.',
  ...
  'hudChrome.nativeUpdate.body':
    'Une nouvelle version de BharatVerse est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'La version {version} de BharatVerse est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.',
