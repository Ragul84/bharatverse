...
export const es: EnTranslations = {
  ...
  "seo": {
    ...
    "description": "Emprende una aventura épica en BharatVerse, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un mundo compartido, sube de nivel y derrota enemigos.",
    "genre": "MMORPG",
