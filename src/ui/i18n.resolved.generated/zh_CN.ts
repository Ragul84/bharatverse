...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      "title": "有可用更新",
      "body": "BharatVerse 有新版本可用。立即更新以获取最新修复和改进。",
      "bodyWithVersion": "BharatVerse {version} 版本已可用。立即更新以获取最新修复和改进。",
      "notNow": "暂不",
      "update": "更新"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "BharatVerse 是一片连绵不绝、需你徒步穿越的大陆，三大区域由南向北依次铺展。这里没有快速旅行，因此旅途本身便是冒险的一部分。",
      "hub": "大本营",
      "mapHeading": "向北之路",
  ...
  "playerCard": {
    ...
    "shareText": "我正在 BharatVerse 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：",
  ...
  "seo": {
    ...
    "description": "在 BharatVerse 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！",
    "genre": "MMORPG",
    "playMode": "多人游戏",
    "applicationCategory": "游戏",
    "operatingSystem": "网页浏览器",
    "officialLabel": "BharatVerse 官方网站",
    "officialBody": "worldofclaudecraft.com 是 Bharat 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。"
  },
  "a11y": {
    "goHome": "前往主页",
    "toggleMenu": "切换菜单",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "重新加载",
      "quit": "退出",
      "fatalBody": "BharatVerse 遇到意外错误，需要关闭。"
    }
  },
  "realm": {
    "noRealms": "没有可用服务器。",
