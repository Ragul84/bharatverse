...
export const fr_CA: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Une nouvelle version de BharatVerse est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.",
      "bodyWithVersion": "La version {version} de BharatVerse est disponible. Mettez à jour maintenant pour les derniers correctifs et améliorations.",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Titre: Champion de Bharat",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Le monde",
      "intro": "BharatVerse est une seule terre continue que l'on traverse à pied, trois zones disposées du sud au nord. Il n'y a pas de voyage rapide, alors le trajet fait partie de l'aventure.",
      "hub": "Camp de base",
  ...
  "editor": {
    ...
    "docTitle": "Éditeur de cartes - BharatVerse",
  ...
  "playerCard": {
    ...
    "shareText": "Je forge ma légende dans BharatVerse : niveau {level} {className}{tierBit}. Rejoignez mon monde :",
  ...
  "seo": {
    ...
    "description": "Lancez-vous dans une aventure épique dans BharatVerse, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un monde partagé et persistant, faites monter vos classes en niveau et terrassez vos ennemis.",
    "genre": "MMORPG",
    "playMode": "Multijoueur",
    "applicationCategory": "Jeu",
    "operatingSystem": "Navigateur Web",
    "officialLabel": "Site officiel de BharatVerse",
    "officialBody": "worldofclaudecraft.com est le MMO gratuit officiel sur navigateur du monde Bharat. Jouez en ligne avec un personnage persistant, explorez en solo hors ligne, lisez le wiki et suivez les liens communautaires vérifiés depuis ce site."
  },
  "a11y": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Recharger",
      "quit": "Quitter",
      "fatalBody": "BharatVerse a rencontré une erreur inattendue et doit se fermer."
    }
  },
  "realm": {
  ...
  "serverUnavailable": {
    "title": "BharatVerse - Monde indisponible",
    "logoAlt": "BharatVerse",
