...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Доступна новая версия BharatVerse. Обновите сейчас, чтобы получить последние исправления и улучшения.",
      "bodyWithVersion": "Доступна версия {version} BharatVerse. Обновите сейчас, чтобы получить последние исправления и улучшения.",
      "notNow": "Не сейчас",
      "update": "Обновить"
    },
    "cameraPrompt": {
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Титул: Чемпион Bharat",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Мир",
      "intro": "BharatVerse - это единый цельный край, который вы пересекаете пешком, три зоны, протянувшиеся с юга на север. Здесь нет быстрых перемещений, так что дорога - это часть приключения.",
      "hub": "Опорная база",
  ...
  "editor": {
    ...
    "docTitle": "Редактор карт - BharatVerse",
  ...
  "playerCard": {
    ...
    "shareText": "Я создаю свою легенду в BharatVerse: уровень {level}, {className}{tierBit}. Присоединяйтесь к моему миру:",
  ...
  "seo": {
    ...
    "description": "Отправьтесь в эпическое приключение в BharatVerse, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к постоянному общему миру, развивайте классы и побеждайте врагов.",
    "genre": "MMORPG",
    "playMode": "Многопользовательская игра",
    "applicationCategory": "Игра",
    "operatingSystem": "Веб-браузер",
    "officialLabel": "Официальный сайт BharatVerse",
    "officialBody": "worldofclaudecraft.com - официальная бесплатная браузерная MMO для мира Bharat. Играйте онлайн с постоянным персонажем, исследуйте мир в одиночку офлайн, читайте wiki и переходите по проверенным ссылкам сообщества с этого сайта."
  },
  "a11y": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "quit": "Выйти",
      "fatalBody": "BharatVerse столкнулась с непредвиденной ошибкой и будет закрыта."
    }
  },
  "realm": {
