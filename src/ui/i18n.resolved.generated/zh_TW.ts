...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      "title": "有可用更新",
      "body": "BharatVerse 有新版本可用。立即更新以取得最新修正與改進。",
      "bodyWithVersion": "BharatVerse {version} 版本已可用。立即更新以取得最新修正與改進。",
      "notNow": "暫不",
      "update": "更新"
    },
    "cameraPrompt": {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "BharatVerse 是一片你需徒步橫越的連綿大地，三大區域由南向北排列。沒有快速旅行，所以旅程本身就是冒險的一部分。",
      "hub": "主據點",
      "mapHeading": "北行之路",
  ...
  "playerCard": {
    ...
    "shareText": "我正在 BharatVerse 中鑄就傳說：{level}級 {className}{tierBit}。加入我的世界：",
  ...
  "seo": {
    ...
    "description": "在 BharatVerse 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的世界，提升職業等級並擊敗敵人！",
    "genre": "MMORPG",
    "playMode": "多人遊戲",
    "applicationCategory": "遊戲",
    "operatingSystem": "網頁瀏覽器",
    "officialLabel": "BharatVerse 官方網站",
    "officialBody": "worldofclaudecraft.com 是 Bharat 世界的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。"
  },
  "a11y": {
    "goHome": "前往首頁",
    "toggleMenu": "切換選單",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "重新載入",
      "quit": "離開",
      "fatalBody": "BharatVerse 發生未預期的錯誤，必須關閉。"
    }
  },
  "realm": {
    "noRealms": "沒有可用的世界。",
