...
export const pt_BR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Uma nova versão do BharatVerse está disponível. Atualize agora para receber as últimas correções e melhorias.",
      "bodyWithVersion": "A versão {version} do BharatVerse está disponível. Atualize agora para receber as últimas correções e melhorias.",
      "notNow": "Agora não",
      "update": "Atualizar"
    },
    "cameraPrompt": {
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Título: Campeão de Bharat",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "O mundo",
      "intro": "BharatVerse é uma terra contínua que você atravessa a pé, três zonas dispostas de sul a norte. Não há viagem rápida, então a jornada faz parte da aventura.",
  ...
  "playerCard": {
    ...
    "shareText": "Estou forjando minha lenda em BharatVerse: nível {level} {className}{tierBit}. Entre no meu mundo:",
  ...
  "seo": {
    ...
    "description": "Embarque em uma aventura épica em BharatVerse, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um mundo compartilhado persistente, evolua classes e derrote inimigos!",
    "genre": "MMORPG",
    "playMode": "Multijogador",
    "applicationCategory": "Jogo",
    "operatingSystem": "Navegador web",
    "officialLabel": "Site oficial de BharatVerse",
    "officialBody": "worldofclaudecraft.com é o MMO de navegador gratuito oficial do mundo Bharat. Jogue online com um personagem persistente, explore solo offline, leia a wiki e siga os links verificados da comunidade a partir deste site."
  },
  "a11y": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Recarregar",
      "quit": "Sair",
      "fatalBody": "O BharatVerse encontrou um erro inesperado e precisa fechar."
    }
  },
  "realm": {
  ...
  "serverUnavailable": {
    "title": "BharatVerse - Mundo indisponível",
    "logoAlt": "BharatVerse",
