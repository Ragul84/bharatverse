...
export const sv_SE: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "En ny version av BharatVerse är tillgänglig. Uppdatera nu för de senaste korrigeringarna och förbättringarna.",
      "bodyWithVersion": "Version {version} av BharatVerse är tillgänglig. Uppdatera nu för de senaste korrigeringarna och förbättringarna.",
      "notNow": "Inte nu",
      "update": "Uppdatera"
    },
    "cameraPrompt": {
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Titel: Champion of Bharat",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Världen",
      "intro": "BharatVerse är ett enda sammanhängande land som du korsar till fots, tre zoner lagda från söder till norr. Det finns ingen snabbresa, så resan är en del av äventyret.",
      "hub": "Hembas",
  ...
  "editor": {
    ...
    "docTitle": "Kartredigerare - BharatVerse",
  ...
  "playerCard": {
    ...
    "shareText": "Jag skapar min legend i BharatVerse: Nivå {level} {className}{tierBit}. Gå med i min värld:",
  ...
  "seo": {
    "title": "BharatVerse: Klassiskt inspirerad webb-MMO",
    "description": "Ge dig ut på ett episkt äventyr i BharatVerse, en klassiskt inspirerad mikro-MMO som du spelar direkt i din webbläsare. Anslut till en beständig delad värld, höj nivå på klasser och besegra fiender!",
    "genre": "MMORPG",
    "playMode": "Flerspelarläge",
    "applicationCategory": "Spel",
    "operatingSystem": "Webbläsare",
    "officialLabel": "Officiell webbplats för BharatVerse",
    "officialBody": "worldofclaudecraft.com är den officiella gratis webbläsar-MMO:n för Bharat-världen. Spela online med en beständig karaktär, utforska solo offline, läs wikin och följ verifierade gemenskapslänkar från den här webbplatsen."
  },
  "a11y": {
    ...
    "githubProject": "Öppna GitHub-projektet BharatVerse",
    "discordCommunity": "Gå med i BharatVerse-gemenskapen på Discord",
    "donateProject": "Donera för att stödja BharatVerse"
  },
  "loading": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Ladda om",
      "quit": "Avsluta",
      "fatalBody": "BharatVerse stötte på ett oväntat fel och måste stängas."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Öppna BharatVerse från den nya Hemskärmsikonen.",
    ...
    "androidOpenStep": "Öppna BharatVerse från den nya ikonen.",
  ...
  "serverUnavailable": {
    "title": "BharatVerse - Världen otillgänglig",
    "logoAlt": "BharatVerse",
    "eyebrow": "Världsunderhåll",
    "heading": "Världen är tillfälligt otillgänglig.",
    "body": "Vi startar om speltjänsten och förväntar oss att Bharat är tillbaka inom kort. Den här sidan fortsätter att kontrollera automatiskt.",
  ...
  "entities": {
    ...
    "npcs": {
      ...
      "auctioneer_voss": {
        ...
        "title": "Väktare av världsmarknaden",
        "greeting": "BharatVerse-marknaden är öppen även här, {className}. Köp från varje äventyrare i riket, eller lägg ut dina egna varor."
      },
      "bursar_fernando": {
