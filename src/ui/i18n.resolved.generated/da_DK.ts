...
export const da_DK: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "En ny version af BharatVerse er tilgængelig. Opdater nu for de nyeste rettelser og forbedringer.",
      "bodyWithVersion": "Version {version} af BharatVerse er tilgængelig. Opdater nu for de nyeste rettelser og forbedringer.",
      "notNow": "Ikke nu",
      "update": "Opdater"
    },
    "cameraPrompt": {
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Titel: Champion af Bharat",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Verdenen",
      "intro": "BharatVerse er ét sammenhængende land, du krydser til fods, tre zoner lagt fra syd til nord. Der er ingen hurtigrejse, så rejsen er en del af eventyret.",
      "hub": "Hjemmebase",
  ...
  "editor": {
    "appTitle": "Korteditor",
    "docTitle": "Korteditor - BharatVerse",
  ...
  "playerCard": {
    ...
    "shareText": "Jeg smeder min legende i BharatVerse: Niveau {level} {className}{tierBit}. Slut dig til min verden:",
  ...
  "seo": {
    "title": "BharatVerse: Klassisk-inspireret web-MMO",
    "description": "Begiv dig ud på et episk eventyr i BharatVerse, en klassisk-inspireret micro-MMO, der kan spilles direkte i din browser. Slut dig til en vedvarende delt verden, lev op dine klasser, og besejr fjender!",
    "genre": "MMORPG",
    "playMode": "Flerspiller",
    "applicationCategory": "Spil",
    "operatingSystem": "Webbrowser",
    "officialLabel": "Officiel BharatVerse-hjemmeside",
    "officialBody": "worldofclaudecraft.com er den officielle gratis browser-MMO for Bharat-verdenen. Spil online med en vedvarende karakter, udforsk solo offline, læs wikien, og følg verificerede fællesskabslinks fra denne side."
  },
  "a11y": {
    ...
    "githubProject": "Åbn BharatVerse GitHub-projektet",
    "discordCommunity": "Deltag i BharatVerse Discord-fællesskabet",
    "donateProject": "Donér for at støtte BharatVerse"
  },
  "loading": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Genindlæs",
      "quit": "Afslut",
      "fatalBody": "BharatVerse stødte på en uventet fejl og skal lukke."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Åbn BharatVerse fra det nye ikon på startskærmen.",
    ...
    "androidOpenStep": "Åbn BharatVerse fra det nye ikon.",
  ...
  "serverUnavailable": {
    "title": "BharatVerse - Verden utilgængelig",
    "logoAlt": "BharatVerse",
    "eyebrow": "Verdens-vedligeholdelse",
    "heading": "Verdenen er midlertidigt utilgængelig.",
    "body": "Vi genstarter spiltjenesten og forventer, at Bharat vender tilbage om kort tid. Denne side bliver ved med at tjekke automatisk.",
