...
export const it_IT: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "È disponibile una nuova versione di BharatVerse. Aggiorna ora per le ultime correzioni e migliorie.",
      "bodyWithVersion": "La versione {version} di BharatVerse è disponibile. Aggiorna ora per le ultime correzioni e migliorie.",
      "notNow": "Non ora",
      "update": "Aggiorna"
    },
    "cameraPrompt": {
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Titolo: Campione di Bharat",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Il mondo",
      "intro": "BharatVerse è una terra continua che attraversi a piedi, tre zone disposte da sud a nord. Non c'è viaggio rapido, perciò il viaggio è parte dell'avventura.",
      "hub": "Base operativa",
  ...
  "editor": {
    ...
    "docTitle": "Editor di Mappe - BharatVerse",
  ...
  "playerCard": {
    ...
    "shareText": "Sto forgiando la mia leggenda in BharatVerse: livello {level} {className}{tierBit}. Unisciti al mio mondo:",
  ...
  "seo": {
    ...
    "description": "Parti per un'avventura epica in BharatVerse, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un mondo condiviso persistente, fai crescere le classi e sconfiggi i nemici!",
    "genre": "MMORPG",
    "playMode": "Multigiocatore",
    "applicationCategory": "Gioco",
    "operatingSystem": "Browser web",
    "officialLabel": "Sito ufficiale di BharatVerse",
    "officialBody": "worldofclaudecraft.com è l'MMO gratuito ufficiale da browser del mondo Bharat. Gioca online con un personaggio persistente, esplora offline in solitaria, leggi il wiki e segui i link della community verificati da questo sito."
  },
  "a11y": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Ricarica",
      "quit": "Esci",
      "fatalBody": "BharatVerse ha riscontrato un errore imprevisto e deve chiudersi."
    }
  },
  "realm": {
  ...
  "serverUnavailable": {
    "title": "BharatVerse - Mondo non disponibile",
    "logoAlt": "BharatVerse",
