...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      "title": "アップデートがあります",
      "body": "BharatVerse の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。",
      "bodyWithVersion": "BharatVerse のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。",
      "notNow": "後で",
      "update": "更新"
    },
    "cameraPrompt": {
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "称号：Bharatのチャンピオン",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "BharatVerseは、自らの足で歩いて渡る一続きの大地です。南から北へと3つのゾーンが連なっています。ファストトラベルはなく、その旅路こそが冒険の一部です。",
      "hub": "拠点",
      "mapHeading": "北への道",
  ...
  "playerCard": {
    ...
    "shareText": "BharatVerseで伝説を鍛えています: レベル{level} {className}{tierBit}。私のワールドに参加してください:",
  ...
  "seo": {
    ...
    "description": "ブラウザで直接遊べるクラシック風マイクロMMO、BharatVerse で壮大な冒険に出ましょう。永続的な共有ワールドに参加し、クラスを育て、敵を倒してください。",
    "genre": "MMORPG",
    "playMode": "マルチプレイヤー",
    "applicationCategory": "ゲーム",
    "operatingSystem": "Webブラウザ",
    "officialLabel": "BharatVerse 公式サイト",
    "officialBody": "worldofclaudecraft.com は Bharat ワールドの公式無料ブラウザMMOです。永続キャラクターでオンラインプレイし、オフラインでソロ探索し、wikiを読み、このサイトから確認済みのコミュニティリンクをたどれます。"
  },
  "a11y": {
    "goHome": "ホームへ移動",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "再読み込み",
      "quit": "終了",
      "fatalBody": "BharatVerse で予期しないエラーが発生したため、終了します。"
    }
  },
  "realm": {
