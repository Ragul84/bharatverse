...
export const tr_TR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "BharatVerse'ın yeni bir sürümü mevcut. En son düzeltmeler ve iyileştirmeler için şimdi güncelle.",
      "bodyWithVersion": "BharatVerse'ın {version} sürümü mevcut. En son düzeltmeler ve iyileştirmeler için şimdi güncelle.",
      "notNow": "Şimdi Değil",
      "update": "Güncelle"
    },
    "cameraPrompt": {
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Unvan: Bharat Şampiyonu",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Dünya",
      "intro": "BharatVerse, yürüyerek aştığınız tek ve kesintisiz bir diyardır; güneyden kuzeye dizilmiş üç bölge. Hızlı seyahat yoktur, bu yüzden yolculuğun kendisi maceranın bir parçasıdır.",
      "hub": "Ana üs",
  ...
  "editor": {
    ...
    "docTitle": "Harita Editörü - BharatVerse",
  ...
  "playerCard": {
    ...
    "shareText": "BharatVerse'ta efsanemi yaratıyorum: Seviye {level} {className}{tierBit}. Dünyama katıl:",
  ...
  "seo": {
    "title": "BharatVerse: Klasik Tarzı Web MMO'su",
    "description": "Doğrudan tarayıcında oynanabilen klasik tarzı bir mikro MMO olan BharatVerse'ta destansı bir maceraya atıl. Kalıcı bir ortak dünyaya katıl, sınıfları geliştir ve düşmanları alt et!",
    "genre": "MMORPG",
    "playMode": "Çok Oyunculu",
    "applicationCategory": "Oyun",
    "operatingSystem": "Web tarayıcısı",
    "officialLabel": "Resmi BharatVerse web sitesi",
    "officialBody": "worldofclaudecraft.com, Bharat dünyasının resmi ücretsiz tarayıcı MMO'sudur. Kalıcı bir karakterle çevrimiçi oyna, çevrimdışı tek başına keşfet, wiki'yi oku ve bu siteden doğrulanmış topluluk bağlantılarını takip et."
  },
  "a11y": {
    ...
    "githubProject": "BharatVerse GitHub projesini aç",
    "discordCommunity": "BharatVerse Discord topluluğuna katıl",
    "donateProject": "BharatVerse'a destek olmak için bağış yap"
  },
  "loading": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "quit": "Çık",
      "fatalBody": "BharatVerse beklenmeyen bir hatayla karşılaştı ve kapatılması gerekiyor."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "BharatVerse'ı yeni Ana Ekran simgesinden açın.",
    ...
    "androidOpenStep": "BharatVerse'ı yeni simgeden açın.",
  ...
  "serverUnavailable": {
    "title": "BharatVerse - Dünya Kullanılamıyor",
    "logoAlt": "BharatVerse",
    "eyebrow": "Dünya bakımı",
    "heading": "Dünya geçici olarak kullanılamıyor.",
    "body": "Oyun hizmetini yeniden başlatıyoruz ve Bharat'un kısa süre içinde geri döneceğini umuyoruz. Bu sayfa otomatik olarak denetlemeye devam edecek.",
