...
export const vi_VN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "nativeUpdate": {
      ...
      "body": "Đã có phiên bản mới của BharatVerse. Cập nhật ngay để nhận các bản sửa lỗi và cải tiến mới nhất.",
      "bodyWithVersion": "Đã có phiên bản {version} của BharatVerse. Cập nhật ngay để nhận các bản sửa lỗi và cải tiến mới nhất.",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Danh Hiệu: Nhà Vô Địch Bharat",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Thế giới",
      "intro": "BharatVerse là một vùng đất liền mạch mà bạn băng qua bằng đôi chân, ba khu vực trải dài từ nam tới bắc. Không có di chuyển nhanh, nên hành trình là một phần của cuộc phiêu lưu.",
      "hub": "Căn cứ nhà",
  ...
  "editor": {
    ...
    "docTitle": "Trình Chỉnh Sửa Bản Đồ - BharatVerse",
  ...
  "playerCard": {
    ...
    "shareText": "Tôi đang rèn nên huyền thoại của mình trong BharatVerse: {className} cấp {level}{tierBit}. Hãy tham gia thế giới của tôi:",
  ...
  "seo": {
    "title": "BharatVerse: MMO Web Phong Cách Cổ Điển",
    "description": "Bắt đầu cuộc phiêu lưu hoành tráng trong BharatVerse, một micro-MMO phong cách cổ điển chơi trực tiếp trên trình duyệt của bạn. Tham gia một thế giới chung bền vững, lên cấp các lớp nhân vật và đánh bại kẻ thù!",
    "genre": "MMORPG",
    "playMode": "Nhiều người chơi",
    "applicationCategory": "Trò chơi",
    "operatingSystem": "Trình duyệt web",
    "officialLabel": "Trang web BharatVerse chính thức",
    "officialBody": "worldofclaudecraft.com là trang MMO trên trình duyệt miễn phí chính thức cho thế giới Bharat. Chơi trực tuyến với một nhân vật bền vững, khám phá đơn lẻ ngoại tuyến, đọc wiki và theo dõi các liên kết cộng đồng đã được xác minh từ trang này."
  },
  "a11y": {
    "goHome": "Về trang chủ",
    ...
    "githubProject": "Mở dự án GitHub của BharatVerse",
    "discordCommunity": "Tham gia cộng đồng Discord của BharatVerse",
    "donateProject": "Quyên góp ủng hộ BharatVerse"
  },
  "loading": {
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "Tải lại",
      "quit": "Thoát",
      "fatalBody": "BharatVerse gặp lỗi không mong muốn và cần đóng lại."
    }
  },
  "realm": {
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Mở BharatVerse từ biểu tượng mới trên Màn hình chính.",
    ...
    "androidOpenStep": "Mở BharatVerse từ biểu tượng mới.",
  ...
  "serverUnavailable": {
    "title": "BharatVerse - Thế Giới Không Khả Dụng",
    "logoAlt": "BharatVerse",
    "eyebrow": "Bảo trì thế giới",
    "heading": "Thế giới tạm thời không khả dụng.",
    "body": "Chúng tôi đang khởi động lại dịch vụ trò chơi và dự kiến Bharat sẽ trở lại trong giây lát. Trang này sẽ tự động tiếp tục kiểm tra.",
    "status": "Sớm trở lại"
  },
  "hud": {
    "core": {
