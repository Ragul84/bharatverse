...
export const DUNGEON_MOBS: Record<string, MobTemplate> = {
  ...
  morthen: {
    id: 'morthen', name: 'Ignorance Fiend', minLevel: 10, maxLevel: 10, family: 'undead',
    ...
    aoePulse: { min: 12, max: 18, radius: 12, every: 10, name: 'Knowledge Drain' },
    loot: [
  ...
  korzul_the_gravewyrm: {
    ...
    aoePulse: { min: 30, max: 42, radius: 14, every: 8, name: 'Ignorance Storm' },
    enrage: { belowHpPct: 0.30, dmgMult: 1.5, hasteMult: 1.3 },
    loot: [
...
export const DUNGEON_DEFS: Record<string, DungeonDef> = {
  hollow_crypt: {
    id: 'hollow_crypt',
    name: 'History Well',  // BharatVerse: History Well — where forgotten knowledge drowns
    index: 0,
  ...
  sunken_bastion: {
    id: 'sunken_bastion',
    name: 'Science Fort',  // BharatVerse: Science Fort — where knowledge is weaponised
    index: 1,
